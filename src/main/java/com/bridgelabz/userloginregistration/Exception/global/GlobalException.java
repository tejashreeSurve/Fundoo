...
public class GlobalException {
	...
	public ResponseEntity<Response> ForgetPasswordException(Exception e) {
		return new ResponseEntity<Response>(new Response(Integer.parseInt(environment.getProperty("status.bad.code")),
				e.getMessage(), message.User_Not_Exist), HttpStatus.BAD_REQUEST);
	}
	...
	public ResponseEntity<Response> ValidateException(Exception e) {
		return new ResponseEntity<Response>(new Response(Integer.parseInt(environment.getProperty("status.bad.code")),
				e.getMessage(), message.User_Not_Verify), HttpStatus.BAD_REQUEST);
	}
}
